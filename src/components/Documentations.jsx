            ...
            <div className="h-[400px] w-full relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-[20px]">
                    ...
                    <motion.div
                        ...
                        className="bg-white rounded-[10px] w-[850px] h-[60px] flex flex-row gap-[10px] items-center px-[20px] shadow-2xl">
                        <SearchIcon className="text-gray-700 mr-[10px]" />
                        <input placeholder="Type your queries..." className="outline-none w-[800px]" />
                        <motion.button
                            whileTap={{ scale: 0.95 }}
                            className="cursor-pointer bg-black/80 hover:bg-black/90 rounded-[10px] text-white h-[40px] px-[10px]">Search</motion.button>
                    </motion.div>
                </div>
            </div>
        </>
